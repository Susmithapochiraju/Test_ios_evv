...
$.post( "http://183.82.96.212:8080/?q=m_service/m_resources/register_device" , { username:encodeURIComponent(name),password:encodeURIComponent(pass),pin:encodeURIComponent(pin),device_uuid:encodeURIComponent(d.value), device_name:encodeURIComponent(n.value),device_model:encodeURIComponent(m.value),device_platform:encodeURIComponent(p.value), device_version:encodeURIComponent(v.value), device_already_registered:encodeURIComponent("0")}, function( data ) {
